...
<body>       
    ...
    <h4>You are given <?php echo $timegiven; ?> x100 milliseconds, for a grand total of <?php echo $give_res = $timeint * 50; ?> to recreate the pattern</h4><br>
    <h4>You will have a squence of <?php echo $maxpatt; ?> patterns</h4><br>
    <h4></h4>

<?php

shell_exec("php /home/xavier/php/custom_settings.php $diff $timeint $timegiven $maxpatt");
